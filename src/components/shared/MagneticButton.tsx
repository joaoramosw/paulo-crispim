...
export function MagneticButton({ children, href, variant = "primary", external = false, className = "" }: MagneticButtonProps) {
  const base = "group relative inline-flex min-h-12 w-full items-center justify-center overflow-hidden px-4 py-3 text-center text-xs font-bold uppercase tracking-[0.14em] transition active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#35F06A] focus-visible:ring-offset-4 focus-visible:ring-offset-[#050708] sm:w-auto sm:px-6 sm:text-sm sm:tracking-[0.18em]";
