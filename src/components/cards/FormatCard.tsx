...
export function FormatCard({ title, description, icon: Icon }: FormatCardProps) {
  return (
    <article className="group relative h-full overflow-hidden border border-[#35F06A]/18 bg-[#35F06A]/[0.045] p-6 transition hover:border-[#35F06A]/45 hover:bg-[#35F06A]/[0.075]">
